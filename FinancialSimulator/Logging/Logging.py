...
from FinancialSimulator.Logging.ExceptionHook import DispatcherExceptionHook, StderrExceptionHook
from FinancialSimulator.Tools.Singleton import singleton
